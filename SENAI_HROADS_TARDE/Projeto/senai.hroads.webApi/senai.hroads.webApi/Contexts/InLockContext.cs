    ...
    public partial class InLockContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-KINHA\\SQLEXPRESS; initial catalog = HROADS; user Id = sa; pwd = 151917;");                  
                //optionsBuilder.UseSqlServer("Data Source=NOTE0113A3\\SQLEXPRESS; initial catalog=HROADS; user Id=sa; pwd=senai@132;");
            }
        }
